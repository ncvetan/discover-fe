        ...
        try {
            ...
            const response = await api.post(
                ...
                JSON.stringify({
                    ...
                    attributes: [],
                    hours: {
                        sun: [{start: formattedTimeToMinutes(sunStart), end: formattedTimeToMinutes(sunEnd)}],
                        mon: [{start: formattedTimeToMinutes(monStart), end: formattedTimeToMinutes(monEnd)}],
                        tue: [{start: formattedTimeToMinutes(tueStart), end: formattedTimeToMinutes(tueEnd)}],
                        wed: [{start: formattedTimeToMinutes(wedStart), end: formattedTimeToMinutes(wedEnd)}],
                        thu: [{start: formattedTimeToMinutes(thurStart), end: formattedTimeToMinutes(thurEnd)}],
                        fri: [{start: formattedTimeToMinutes(friStart), end: formattedTimeToMinutes(friEnd)}],
                        sat: [{start: formattedTimeToMinutes(satStart), end: formattedTimeToMinutes(satEnd)}],
                    },
                    review: []
                }),
                {
